...
selected = IntVar()
rad1 = Radiobutton(root, text='BAT', value=1, bg="white", activebackground="white", font=('Comic Sans MS', 9),
                   variable=selected, command=selection)
rad2 = Radiobutton(root, text='BOW', value=2, bg="white", activebackground="white", font=('Comic Sans MS', 9),
                   variable=selected, command=selection)
rad3 = Radiobutton(root, text='AR', value=3, bg="white", activebackground="white", font=('Comic Sans MS', 9),
                   variable=selected, command=selection)
rad4 = Radiobutton(root, text='WK', value=4, bg="white", activebackground="white", font=('Comic Sans MS', 9),
                   variable=selected, command=selection)
