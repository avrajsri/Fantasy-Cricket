...
#5
def go(event):
    value = str((titleList1.get(ACTIVE)))
    print(value)
...
def show(u):
    ...
    global titleList1
    titleList1 = Listbox(root, font=('Comic Sans MS', 12), listvariable=u, highlightcolor="white", bd=0, width=22,height=6, fg="#497CFF", selectbackground="#CCFFFF", selectforeground="#497CFF")
    titleList1.bind("<Double-1>", go)
