...
titleList = Listbox(root, listvariable=title, bd=0, width=28, height=8, fg="#497CFF", font=('Comic Sans MS',10), selectbackground="#CCFFFF",selectforeground="#497CFF")
for t in title:
	titleList.insert(END, t)
titleList.place(x=81, y=200)
